...
export function ClientDashboard() {
      ...
      <div className="flex min-h-screen items-center justify-center px-4 text-center">
        <div className="max-w-md">
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            Contactez {BRAND.owner} si vous pensez qu&apos;il s&apos;agit d&apos;une erreur.
          </p>
        </div>
      </div>
    )
    ...
    return (
      <div className="flex min-h-screen items-center justify-center px-4 text-center">
        <p className="text-sm text-muted-foreground">
          Impossible de charger votre profil. Reconnectez-vous ou contactez {BRAND.owner}.
        </p>
      </div>
    )
  }
  ...
  const titles: Record<string, { title: string; subtitle: string }> = {
    ...
    messages: { title: 'Messages', subtitle: `Discussion privee avec ${BRAND.owner}.` },
        ...
        <Card className="border-primary/20 bg-primary/5">
          <CardContent className="p-5">
            ...
            <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
              Contactez {BRAND.owner} directement dans votre discussion privee.
            </p>
            <button
