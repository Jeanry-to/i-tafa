...
import { CheckCircle2, Clock3, Loader2, PauseCircle } from 'lucide-react'
  ...
  async function saveSuspension(event: React.FormEvent) {
    ...
    try {
      ...
      toast.success('Client suspendu', {
        description: 'Le motif est visible uniquement par ce client.',
      })
  ...
  async function validate(client: Client) {
    ...
    try {
      ...
      toast.success('Client validé', {
        description: `${client.name} peut maintenant accéder à son espace.`,
      })
    ...
    <div className="flex max-w-5xl flex-col gap-4">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Validez les nouveaux clients, suspendez temporairement un compte
          ou réactivez un client suspendu.
        </p>
      </div>
            ...
            >
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Le client ne pourra plus accéder à son espace tant que la
              ...
              <div className="flex flex-col gap-2">
                ...
                <Textarea
                  ...
                  placeholder="Ex. : Paiement en attente de vérification"
                  required
                />
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Sans date, la suspension reste active jusqu'à une
      ...
      {clients.length === 0 ? (
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {clients.map((client) => {
            ...
            const pending = client.status === 'en_attente'
              ...
              >
                <CardContent className="p-5">
                  ...
                  <div className="mt-4 space-y-1 text-sm text-muted-foreground">
                    ...
                    {suspended && client.suspensionReason && (
                      <p>Motif : {client.suspensionReason}</p>
                    )}
