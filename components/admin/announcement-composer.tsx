...
import { FileText, ImageIcon, Loader2, Megaphone, Paperclip, Pencil, Send, Trash2, Video, X } from 'lucide-react'
...
export function AnnouncementComposer() {
  ...
  async function publish(e: React.FormEvent) {
    ...
    try {
      ...
      let attachment: { type: AttachmentType; name: string; url: string } | undefined
      if (pendingFile) {
                ...
                <CardContent className="p-5">
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3">
                      <InitialsAvatar name="Admin" className="size-9" />
                      <div>
